...
public class loginDAO 
{
    ...
    public String bc(String pickup,String dropin,String w) throws ClassNotFoundException, SQLException 
    {
        java.sql.Connection con=null;
        java.sql.PreparedStatement pr=null;
        String myUrl="jdbc:mysql://localhost/juno";
        Class.forName("com.mysql.jdbc.Driver");
        con=DriverManager.getConnection(myUrl,"root","");
        String query="insert into book(pickFrom,pickTo,pickWhen) values(?,?,?)";
        pr=con.prepareStatement(query);
     ...
     public String feed(String name,String email,String msg) throws ClassNotFoundException, SQLException 
    {
        java.sql.Connection con=null;
        java.sql.PreparedStatement pr=null;
        String myUrl="jdbc:mysql://localhost/juno";
        Class.forName("com.mysql.jdbc.Driver");
        con=DriverManager.getConnection(myUrl,"root","");
        String query="insert into feedback(Full Name, Email, Message) values(?,?,?)";
        pr=con.prepareStatement(query);
        pr.setString(1,name);
        pr.setString(2,email);
        pr.setString(3,msg);
     ...
     public String add1(String email,String pass,String cp ) throws ClassNotFoundException, SQLException 
    {
        ...
        Class.forName("com.mysql.jdbc.Driver");
        con=DriverManager.getConnection(myUrl,"root","");
        String query="insert into reset(email,password,confirm password) values(?,?,?)";
        pr=con.prepareStatement(query);
